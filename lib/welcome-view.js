  ...
  constructor (props) {
    ...
    this.element.addEventListener('click', (event) => {
      ...
      if (link && link.dataset.event) {
        Reporter.sendEvent(`clicked-welcome-${link.dataset.event}-link`)
      }
    })
  }
      ...
      <div className='welcome'>
        <div className='welcome-container'>
          ...
          <footer className='welcome-footer'>
            <a href="https://atom.io/" dataset={{event: "footer-atom-io"}}>atom.io</a> <span className="text-subtle">×</span> <a className="icon icon-octoface" href="https://github.com/" dataset={{event: "footer-octocat"}}></a>
          </footer>
        </div>
      </div>
    )
