...
export default class GuideView {
  constructor (props) {
    ...
    this.didClickStylingButton = this.didClickThemesButton.bind(this)
  ...
  didExpandOrCollapseSection () {
    const sectionName = this.dataset.section
    const action = this.hasAttribute('open') ? 'collapse' : 'expand'
    console.log(`${action}-${sectionName}-section`);
